...
class BadgeSeeder extends Seeder
{
    ...
    private function generateInteractiveBadges(): array
    {
        ...
        $badges[] = ['code' => 'level_40_milestone', 'name' => 'Proficient Expert', 'description' => 'Mencapai level 40 - Menyelesaikan tier Intermediate', 'type' => BadgeType::Milestone, 'rarity' => 'uncommon', 'xp_reward' => 200, 'threshold' => 40, 'rules' => [['event_trigger' => 'level_reached', 'conditions' => ['level' => 40]]]];
        $badges[] = ['code' => 'level_50_milestone', 'name' => 'Advanced Specialist', 'description' => 'Mencapai level 50 - Menyelesaikan tier Proficient', 'type' => BadgeType::Milestone, 'rarity' => 'rare', 'xp_reward' => 300, 'threshold' => 50, 'rules' => [['event_trigger' => 'level_reached', 'conditions' => ['level' => 50]]]];
        $badges[] = ['code' => 'level_60_milestone', 'name' => 'Expert Champion', 'description' => 'Mencapai level 60 - Menyelesaikan tier Advanced', 'type' => BadgeType::Milestone, 'rarity' => 'rare', 'xp_reward' => 400, 'threshold' => 60, 'rules' => [['event_trigger' => 'level_reached', 'conditions' => ['level' => 60]]]];
        $badges[] = ['code' => 'level_70_milestone', 'name' => 'Master Virtuoso', 'description' => 'Mencapai level 70 - Menyelesaikan tier Expert', 'type' => BadgeType::Milestone, 'rarity' => 'epic', 'xp_reward' => 500, 'threshold' => 70, 'rules' => [['event_trigger' => 'level_reached', 'conditions' => ['level' => 70]]]];
        $badges[] = ['code' => 'level_80_milestone', 'name' => 'Grand Master', 'description' => 'Mencapai level 80 - Menyelesaikan tier Master', 'type' => BadgeType::Milestone, 'rarity' => 'epic', 'xp_reward' => 700, 'threshold' => 80, 'rules' => [['event_trigger' => 'level_reached', 'conditions' => ['level' => 80]]]];
        ...
        for ($i = 1; $i <= 19; $i++) {
            $badges[] = [
                ...
                'rarity' => $i <= 5 ? 'common' : ($i <= 10 ? 'uncommon' : ($i <= 15 ? 'rare' : 'epic')),
                'xp_reward' => max(10, $i * 5),
                'threshold' => $i,
        ...
        $badges[] = ['code' => 'weekend_warrior_unit', 'name' => 'Pejuang Akhir Pekan', 'description' => 'Menyelesaikan 5 Unit di akhir pekan.', 'type' => BadgeType::Habit, 'rarity' => 'uncommon', 'xp_reward' => 50, 'threshold' => 5, 'rules' => [['event_trigger' => 'unit_completed', 'conditions' => ['is_weekend' => true]]]];
        $badges[] = ['code' => 'weekend_warrior_lesson', 'name' => 'Belajar Tanpa Henti', 'description' => 'Menyelesaikan 5 Lesson di akhir pekan.', 'type' => BadgeType::Habit, 'rarity' => 'uncommon', 'xp_reward' => 50, 'threshold' => 5, 'rules' => [['event_trigger' => 'lesson_completed', 'conditions' => ['is_weekend' => true]]]];
        ...
        for ($i = 1; $i <= 17; $i++) {
            $badges[] = [
                ...
                'rarity' => ($i * 3) <= 15 ? 'common' : (($i * 3) <= 30 ? 'uncommon' : (($i * 3) <= 45 ? 'rare' : 'epic')),
                'xp_reward' => max(10, $i * 10),
                'threshold' => 1,
                'rules' => [['event_trigger' => 'daily_login', 'conditions' => ['min_streak_days' => ($i * 3)]]],
            ];
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            $badges[] = [
                ...
                'rarity' => $i <= 3 ? 'common' : ($i <= 6 ? 'uncommon' : 'rare'),
                'xp_reward' => max(10, $i * 10),
                'threshold' => ($i * 5),
                'rules' => [['event_trigger' => 'reply_created']],
            ];
        }
