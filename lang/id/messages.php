...
return [
    ...
    'units' => [
        ...
        'delete_queued' => 'Permintaan hapus unit diterima dan sedang diproses di background.',
    ...
    'lessons' => [
        ...
        'marked_complete' => 'Lesson berhasil ditandai selesai.',
        'marked_incomplete' => 'Lesson berhasil ditandai belum selesai.',
        'locked_cannot_complete' => 'Lesson ini terkunci. Selesaikan prasyarat terlebih dahulu.',
        'locked_cannot_uncomplete' => 'Lesson ini terkunci. Anda tidak dapat membatalkan penyelesaian.',
        'already_completed' => 'Lesson ini sudah ditandai selesai.',
        'not_completed' => 'Lesson ini belum ditandai selesai.',
    ...
    'assignments' => [
        ...
        'locked' => 'Tugas ini terkunci. Selesaikan prasyarat terlebih dahulu untuk mengakses tugas ini.',
    ...
    'submissions' => [
        ...
        'not_enrolled' => 'Anda belum terdaftar pada course ini.',
        'assignment_locked' => 'Tugas ini terkunci. Selesaikan :count prasyarat terlebih dahulu untuk mengakses tugas ini.',
    ...
    'quizzes' => [
        ...
        'locked' => 'Kuis ini terkunci. Selesaikan prasyarat terlebih dahulu untuk mengakses kuis ini.',
        'locked_cannot_start' => 'Kuis ini terkunci. Selesaikan :count prasyarat terlebih dahulu untuk mengakses kuis ini.',
        'created' => 'Kuis berhasil dibuat.',
        'updated' => 'Kuis berhasil diperbarui.',
        'deleted' => 'Kuis berhasil dihapus.',
        'published' => 'Kuis berhasil dipublish.',
        'unpublished' => 'Kuis berhasil diunpublish.',
        ...
        'invalid_scope' => 'Scope kuis tidak valid.',
        'scope_not_found' => 'Scope kuis tidak ditemukan.',
    ],

    'quiz_submissions' => [
        'draft_exists' => 'Anda memiliki percobaan kuis yang belum selesai. Harap selesaikan atau batalkan terlebih dahulu.',
        'pending_grading' => 'Pengumpulan kuis sebelumnya masih dalam proses penilaian.',
        'not_found' => 'Pengumpulan kuis tidak ditemukan.',
        'list_retrieved' => 'Daftar pengumpulan kuis berhasil diambil.',
        'started' => 'Kuis berhasil dimulai.',
        'submitted' => 'Kuis berhasil dikumpulkan.',
    ],
    ...
    'trash_bins' => [
        ...
        'restore_queued' => 'Permintaan restore trash berhasil diterima dan sedang diproses di background.',
        'restore_all_success' => 'Berhasil memulihkan semua item trash.',
        'restore_all_queued' => 'Permintaan restore semua trash berhasil diterima dan sedang diproses di background.',
        'bulk_restore_success' => 'Berhasil memulihkan item trash terpilih.',
        'bulk_restore_queued' => 'Permintaan bulk restore trash berhasil diterima dan sedang diproses di background.',
        'force_deleted' => 'Item trash berhasil dihapus permanen.',
        'force_delete_queued' => 'Permintaan hapus permanen trash berhasil diterima dan sedang diproses di background.',
        'force_delete_all_success' => 'Berhasil menghapus permanen semua item trash.',
        'force_delete_all_queued' => 'Permintaan hapus permanen semua trash berhasil diterima dan sedang diproses di background.',
        'bulk_force_delete_success' => 'Berhasil menghapus permanen item trash terpilih.',
        'bulk_force_delete_queued' => 'Permintaan bulk hapus permanen trash berhasil diterima dan sedang diproses di background.',
