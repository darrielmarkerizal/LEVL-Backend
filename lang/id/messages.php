...
return [
  ...
  "common" => [
    ...
    "user-status" => "Daftar status pengguna",
    "course-status" => "Daftar status kursus",
    "course-types" => "Daftar tipe kursus",
    "enrollment-types" => "Daftar tipe pendaftaran",
    "level-tags" => "Daftar level kesulitan",
    "progression-modes" => "Daftar mode progres",
    "content-types" => "Daftar tipe konten",
    "enrollment-status" => "Daftar status pendaftaran",
    "progress-status" => "Daftar status progres",
    "assignment-status" => "Daftar status tugas",
    "submission-status" => "Daftar status pengumpulan",
    "submission-types" => "Daftar tipe pengumpulan",
    "content-status" => "Daftar status konten",
    "priorities" => "Daftar prioritas",
    "target-types" => "Daftar tipe target",
    "challenge-types" => "Daftar tipe tantangan",
    "challenge-assignment-status" => "Daftar status tantangan user",
    "challenge-criteria-types" => "Daftar tipe kriteria tantangan",
    "badge-types" => "Daftar tipe badge",
    "point-source-types" => "Daftar sumber poin",
    "point-reasons" => "Daftar alasan poin",
    "notification-types" => "Daftar tipe notifikasi",
    "notification-channels" => "Daftar channel notifikasi",
    "notification-frequencies" => "Daftar frekuensi notifikasi",
    "grade-status" => "Daftar status nilai",
    "grade-source-types" => "Daftar sumber nilai",
    "category-status" => "Daftar status kategori",
    "setting-types" => "Daftar tipe pengaturan",
  ],
