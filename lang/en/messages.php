...
return [
    ...
    'questions' => [
        ...
        'weight_required_to_publish' => 'All questions must have a weight before the quiz can be published.',
        ...
        'options_min_two' => 'Answer options must have at least 2 choices.',
        'answer_key_required' => 'An answer key is required for this question type.',
        'answer_key_out_of_range' => 'Answer key index :index is invalid. Options are only available from index 0 to :max.',
        'max_score_not_applicable' => 'Max score per question only applies to essay type. For objective questions, use weight instead.',
    ...
    'courses' => [
        ...
        'duplicate_field_value' => 'The :field ":value" is already in use. Please choose a different value.',
        'duplicate_constraint' => 'Duplicate data detected on constraint :constraint.',
