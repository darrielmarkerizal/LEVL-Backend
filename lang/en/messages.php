...
return [
    ...
    'units' => [
        ...
        'delete_queued' => 'Unit delete request accepted and is being processed in background.',
    ...
    'lessons' => [
        ...
        'marked_complete' => 'Lesson marked as complete successfully.',
        'marked_incomplete' => 'Lesson marked as incomplete successfully.',
        'locked_cannot_complete' => 'This lesson is locked. Complete the prerequisites first.',
        'locked_cannot_uncomplete' => 'This lesson is locked. You cannot uncomplete it.',
        'already_completed' => 'This lesson has already been completed.',
    ...
    'assignments' => [
        ...
        'locked' => 'This assignment is locked. Complete the prerequisites first to access this assignment.',
    ...
    'submissions' => [
        ...
        'not_enrolled' => 'You are not enrolled in this course.',
        'assignment_locked' => 'This assignment is locked. Complete :count prerequisite(s) first to access this assignment.',
    ...
    'quizzes' => [
        ...
        'locked' => 'This quiz is locked. Complete the prerequisites first to access this quiz.',
        'locked_cannot_start' => 'This quiz is locked. Complete :count prerequisite(s) first to access this quiz.',
        ...
        'invalid_scope' => 'Invalid quiz scope.',
        'scope_not_found' => 'Quiz scope not found.',
    ],

    'quiz_submissions' => [
        'draft_exists' => 'You have an unfinished quiz attempt. Please complete or abandon it first.',
        'pending_grading' => 'Your previous quiz submission is still being graded.',
        'not_found' => 'Quiz submission not found.',
        'list_retrieved' => 'Quiz submissions retrieved successfully.',
        'started' => 'Quiz started successfully.',
        'submitted' => 'Quiz submitted successfully.',
    ],
    ...
    'trash_bins' => [
        ...
        'restore_queued' => 'Trash restore request accepted and is being processed in background.',
        'restore_all_success' => 'Successfully restored all trash items.',
        'restore_all_queued' => 'Restore all trash request accepted and is being processed in background.',
        'bulk_restore_success' => 'Successfully restored selected trash items.',
        'bulk_restore_queued' => 'Bulk restore trash request accepted and is being processed in background.',
        'force_deleted' => 'Trash item permanently deleted successfully.',
        'force_delete_queued' => 'Trash permanent delete request accepted and is being processed in background.',
        'force_delete_all_success' => 'Successfully permanently deleted all trash items.',
        'force_delete_all_queued' => 'Force delete all trash request accepted and is being processed in background.',
        'bulk_force_delete_success' => 'Successfully permanently deleted selected trash items.',
        'bulk_force_delete_queued' => 'Bulk force delete trash request accepted and is being processed in background.',
